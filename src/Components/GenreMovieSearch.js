...
export default function GenreMovieSearch({ handleGenre, value }) {
  let url = `${baseApiUrl}/genre/movie/list?api_key=${apiKey}`;
  ...
  return (
    <FormControl variant="standard" sx={{ m: 1, minWidth: 200, color: "#fff" }}>
      <FormLabel
